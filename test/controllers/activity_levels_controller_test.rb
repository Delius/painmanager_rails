...
class ActivityLevelsControllerTest < ActionController::TestCase
  ...
  test "should create activity_level" do
    assert_difference('ActivityLevel.count') do
      post :create, activity_level: { act_name: @activity_level.act_name, diary_id: @activity_level.diary_id, user_id: @activity_level.user_id }
    end
  ...
  test "should update activity_level" do
    patch :update, id: @activity_level, activity_level: { act_name: @activity_level.act_name, diary_id: @activity_level.diary_id, user_id: @activity_level.user_id }
    assert_redirected_to activity_level_path(assigns(:activity_level))
  end
